...
//        /// </summary>
//        private static readonly string[] _scopes = { "https://management.azure.com/.default" };
...
//        /// <returns></returns>
//        public static async Task<CarbonOptimizationClient> Create(string clientId, string clientSecret, string tenantId)
//        {
